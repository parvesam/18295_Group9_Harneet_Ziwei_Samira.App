...
namespace _18295_Group9_Harneet_Ziwei_Samira.Models
{
    ...
    public static class HallRepository
    {
        ...
        static HallRepository()
        {
            ...
            var hall2 = new Hall { Name = "Cinema 2", Location = "Location 2", NumberOfSeats = 25, HallName = "Hall B" };
            ...
            var hall5 = new Hall { Name = "Cinema 5", Location = "Location 5", NumberOfSeats = 30, HallName = "Hall E" };
            var hall6 = new Hall { Name = "Cinema 6", Location = "Location 6", NumberOfSeats = 25, HallName = "Hall F" };
            var hall7 = new Hall { Name = "Cinema 7", Location = "Location 7", NumberOfSeats = 30, HallName = "Hall G" };
            var hall8 = new Hall { Name = "Cinema 8", Location = "Location 8", NumberOfSeats = 30, HallName = "Hall H" };
