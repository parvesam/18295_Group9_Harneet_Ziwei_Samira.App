...
namespace _18295_Group9_Harneet_Ziwei_Samira.Models
{
    public static class MoviesRepository
    {
            ...
            _movies = new List<Movie>
        {
            ...
            new Movie { Name = "The Mountain", Genre = "Adventure", Duration = 110, Language = "Turkish", MainActor="Ahmet Mumtaz Taylan", Description="A group of mountaineers embark on a dangerous expedition to climb a remote peak in Turkey, facing extreme weather conditions and personal conflicts along the way.",ImageUrl="https://upload.wikimedia.org/wikipedia/en/4/40/The_Mountain_%282012_film%29_poster.jpg"},
            ...
            new Movie { Name = "Inside", Genre = "Horror", Duration = 95, Language = "French", MainActor="Alysson Paradis", Description="A pregnant woman is terrorized by a mysterious stranger who wants to take her unborn baby, leading to a violent and suspenseful battle for survival.",ImageUrl="https://upload.wikimedia.org/wikipedia/en/2/21/Inside_2018_poster.jpg" },
            ...
            new Movie { Name = "Golmaal", Genre = "Comedy", Duration = 85, Language = "Hindi", MainActor="Ajay Devgn", Description="A group of friends fabricate a fake blind man to avoid paying rent, leading to a string of hilarious lies and situations.",ImageUrl="https://upload.wikimedia.org/wikipedia/en/b/b4/Golmaal-Fun_Unlimited.jpg" },
